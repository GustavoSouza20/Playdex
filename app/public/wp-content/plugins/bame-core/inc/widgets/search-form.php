...
class bame_search_form_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                'bame_search_form_widget',

                // Widget name will appear in UI

                esc_html__( 'Bame :: Search Form', 'bame' ),
                ...
                array(
                    ...
                    'description'                   => esc_html__( 'Add Search Form Widget', 'bame' ),
                )
            );
        }
        ...
        public function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'placeholder' ); ?>"><?php _e( 'Search:' ,'bame'); ?></label>
    ...
    } // Class bame_search_form_widget ends here


    // Register and load the widget
    function bame_search_form_load_widget() {
        register_widget( 'bame_search_form_widget' );
    }
    add_action( 'widgets_init', 'bame_search_form_load_widget' );