...
add_filter( 'loop_shop_per_page', 'bame_new_loop_shop_per_page', 20 );

function bame_new_loop_shop_per_page( $product_count ) {

    if( class_exists('ReduxFramework') ) { 

        $product_count = bame_opt( 'bame_woo_product_perpage' );
...
add_filter('woocommerce_product_loop_start','bame_woocommerce_product_loop_start');

function bame_woocommerce_product_loop_start( ) {
...
add_filter('woocommerce_product_loop_end','bame_woocommerce_product_loop_end');

function bame_woocommerce_product_loop_end( ) {
...
add_filter('woocommerce_format_sale_price','bame_woocommerce_format_sale_price',10,3);

function bame_woocommerce_format_sale_price( $price, $regular_price, $sale_price ) {
...
add_filter('woocommerce_review_gravatar_size','bame_woocommerce_review_gravatar_size');

function bame_woocommerce_review_gravatar_size() {
...
add_filter('woocommerce_output_related_products_args','bame_woocommerce_output_related_products_args',10,1);

function bame_woocommerce_output_related_products_args( $args ) {

    if( class_exists('ReduxFramework') ) {

        $args['posts_per_page'] = bame_opt('bame_woo_relproduct_num');
...
add_filter('woocommerce_upsell_display_args','bame_woocommerce_upsell_display_args',10,1);

function bame_woocommerce_upsell_display_args( $args ) {

    if( class_exists('ReduxFramework') ) {

        $args['posts_per_page'] = bame_opt('bame_woo_upsellproduct_num');
...
function woocommerce_cross_sells_total( $limit ) {
    ...
    if( class_exists('ReduxFramework') ) {
        ...
        $limit = bame_opt('bame_woo_crosssellproduct_num');
...
add_filter( 'woocommerce_add_to_cart_fragments', 'bame_refresh_mini_cart_count');

function bame_refresh_mini_cart_count($fragments){
...
add_filter( 'woocommerce_checkout_fields' , 'bame_override_checkout_fields' );

function bame_override_checkout_fields( $fields  ){
    ...
    $fields['billing']['billing_first_name']['placeholder'] = esc_attr__('First Name', 'bame');
    ...
    $fields['billing']['billing_last_name']['placeholder'] = esc_attr__('Last Name', 'bame');
    ...
    $fields['billing']['billing_company']['placeholder'] = esc_attr__('Company name (optional)', 'bame');
    ...
    $fields['billing']['billing_phone']['placeholder'] = esc_attr__('Phone', 'bame');
    ...
    $fields['billing']['billing_email']['placeholder'] = esc_attr__('Email address', 'bame');
    ...
    $fields['billing']['billing_city']['placeholder'] = esc_attr__('Town / City', 'bame');
    ...
    $fields['billing']['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'bame');
    ...
    $fields['shipping']['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'bame');
    ...
    $fields['shipping']['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'bame');
    ...
    $fields['shipping']['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'bame');
    ...
    $fields['shipping']['shipping_phone']['placeholder'] = esc_attr__('Phone', 'bame');
    ...
    $fields['shipping']['shipping_email']['placeholder'] = esc_attr__('Email address', 'bame');
    ...
    $fields['shipping']['shipping_city']['placeholder'] = esc_attr__('Town / City', 'bame');
    ...
    $fields['shipping']['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'bame');
...
add_filter( 'woocommerce_default_address_fields', 'bame_override_default_locale_fields' );

function bame_override_default_locale_fields( $fields ) {
...
add_filter( 'woocommerce_billing_fields' , 'bame_custom_billing_fields' );

function bame_custom_billing_fields( $fields ) {
    ...
    $fields['billing_first_name']['placeholder'] = esc_attr__('First Name', 'bame');
    ...
    $fields['billing_last_name']['placeholder'] = esc_attr__('Last Name', 'bame');
    ...
    $fields['billing_company']['placeholder'] = esc_attr__('Company name (optional)', 'bame');
    ...
    $fields['billing_phone']['placeholder'] = esc_attr__('Phone', 'bame');
    ...
    $fields['billing_email']['placeholder'] = esc_attr__('Email address', 'bame');
    ...
    $fields['billing_city']['placeholder'] = esc_attr__('Town / City', 'bame');
    ...
    $fields['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'bame');
...
add_filter( 'woocommerce_shipping_fields' , 'bame_custom_shipping_fields' );

function bame_custom_shipping_fields( $fields ) {
    ...
    $fields['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'bame');
    ...
    $fields['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'bame');
    ...
    $fields['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'bame');
    ...
    $fields['shipping_phone']['placeholder'] = esc_attr__('Phone', 'bame');
    ...
    $fields['shipping_email']['placeholder'] = esc_attr__('Email address', 'bame');
    ...
    $fields['shipping_city']['placeholder'] = esc_attr__('Town / City', 'bame');
    ...
    $fields['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'bame');
...
add_action('woocommerce_before_main_content','bame_shop_col_start_cb');



// Shop column end wrapper hook

add_action('woocommerce_after_main_content','bame_shop_col_end_cb',10);



// shop main content hook

add_action('bame_shop_main_content','bame_shop_main_content_cb',10);



// shop main content end hook

add_action('bame_shop_main_content_end','bame_shop_main_content_end_cb',10);



// bame woocommerce pagination hook

add_action('woocommerce_after_shop_loop','bame_woocommerce_pagination',10);



// bame woocommerce filter wrapper hook

add_action('woocommerce_before_shop_loop','bame_woocommerce_filter_wrapper',20);



// bame woocommerce product content wrapper

add_action('bame_woocommerce_product_content', 'bame_woocommerce_tab_content_wrapper_start', 10 );

add_action('bame_woocommerce_product_content', 'bame_grid_tab_content_cb', 10 );

add_action('bame_woocommerce_product_content', 'bame_list_tab_content_cb', 20 );

add_action('bame_woocommerce_product_content', 'bame_woocommerce_tab_content_wrapper_end', 30 );



// bame woocommerce get sidebar

add_action('woocommerce_sidebar','bame_woocommerce_get_sidebar',10);
...
// bame shop loop product thumbnail hook

add_action( 'woocommerce_before_shop_loop_item', 'bame_loop_product_thumbnail', 10 );



// bame shop loop hozrizontal product thumbnail hook

add_action( 'woocommerce_before_shop_horizontal_loop_item', 'bame_loop_horiontal_product_thumbnail', 10 );



// bame shop loop horizontal product summary hook

add_action('bame_woocommerce_shop_three_loop_product_summary','bame_woocommerce_shop_three_loop_product_summary_cb',10);
...
add_action('woocommerce_before_single_product_summary', 'bame_woocommerce_before_single_product_summary',10);



// single product title

add_action('woocommerce_single_product_summary', 'bame_woocommerce_single_product_title', 30 );



// single product price and rating

add_action('woocommerce_single_product_summary', 'bame_woocommerce_single_product_price_rating', 20 );



// single product excerpt

add_action('woocommerce_single_product_summary', 'bame_woocommerce_single_product_excerpt', 40 );



// single product availability

add_action( 'woocommerce_single_product_summary', 'bame_woocommerce_single_product_availability', 50 );



// single product add to cart button

add_action('woocommerce_single_product_summary','bame_woocommerce_single_add_to_cart_button',60);



// single product meta hook

add_action('woocommerce_single_product_summary','bame_woocommerce_single_meta',80);



// single product sidebar

add_action('bame_woocommerce_single_product_sidebar','bame_woocommerce_single_product_sidebar_cb');
...
add_action('bame_quickview_before_single_product_summary','bame_woocommerce_before_single_product_summary',10);



// single product price and rating

add_action('bame_quickview_single_product_summary','bame_woocommerce_single_product_price_rating',20);



// single product title

add_action('bame_quickview_single_product_summary','bame_woocommerce_quickview_single_product_title',30);



// single product excerpt

add_action('bame_quickview_single_product_summary','bame_woocommerce_single_product_excerpt',40);



// single product add to cart button

add_action('bame_quickview_single_product_summary','bame_woocommerce_single_add_to_cart_button',60);
...
add_action('woocommerce_review_before_comment_meta','bame_woocommerce_reviewer_meta',10,1);
...
add_action('woocommerce_proceed_to_checkout','bame_woocommerce_button_proceed_to_checkout',20);



// cross sell products

add_action('woocommerce_after_cart','bame_woocommerce_cross_sell_display',10);



// mini cart view cart button

add_action('woocommerce_widget_shopping_cart_buttons','bame_minicart_view_cart_button',10);



// mini cart checkout button

add_action('woocommerce_widget_shopping_cart_buttons','bame_minicart_checkout_button',20);
...
// bame woocommerce checkout login form

add_action('woocommerce_before_checkout_form','bame_woocommerce_before_checkout_form',10);
...
add_filter( 'wooscp_button_html', 'bame_wooscp_button_html', 10, 2 );

function bame_wooscp_button_html( $output , $prodid ) {
...
add_filter( 'wooscp_button_text_added', 'bame_woo_compare_btn_text_added', 10, 2 );

function bame_woo_compare_btn_text_added( ){
...
add_filter( 'wooscp_button_text', 'bame_compare_btn_text', 10, 2 );

function bame_compare_btn_text(){
...
add_filter( 'woosq_button_html', 'bame_woosq_button_html', 10, 2 );

function bame_woosq_button_html( $output , $prodid ) {
