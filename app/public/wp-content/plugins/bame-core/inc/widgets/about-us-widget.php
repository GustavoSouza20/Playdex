...
class bame_aboutus_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                esc_html__( 'Bame :: About Us Widget', 'bame' ),

                // Widget description
                array(
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add About Us Widget', 'bame' ),
                    'classname'                     => 'no-class',
                )
            );
        ...
        public function form( $instance ) {
            ...
            ?>
             <p>
                ...
                <label for="<?php echo $this->get_field_id( 'logo_title' ); ?>"><?php _e( 'Display Logo Or Title?' ); ?></label>
            </p>
            <p>
                <label for="<?php echo $this->get_field_id( 'logo_url' ); ?>"><?php _e( 'Logo URL:' ,'bame'); ?></label>
            ...
            <p>
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" placeholder="<?php echo esc_attr__('About Us', 'bame'); ?>" value="<?php echo esc_attr( $title ); ?>" />
            </p>
            <p>
    ...
    } // Class bame_aboutus_widget ends here


    // Register and load the widget
    function bame_aboutus_load_widget() {
        register_widget( 'bame_aboutus_widget' );
    }
    add_action( 'widgets_init', 'bame_aboutus_load_widget' );