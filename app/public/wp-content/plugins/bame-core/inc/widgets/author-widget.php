...
class bame_author_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                esc_html__( 'Bame :: Author Widget', 'bame' ),

                // Widget description
                array(
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add Author Widget', 'bame' ),
                    'classname'                     => 'no-class',
                )
            );
        ...
        public function form( $instance ) {
        	...
        	?>
            <p>
                <label for="<?php echo $this->get_field_id( 'author_img_url' ); ?>"><?php _e( 'Image URL:' ,'bame'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'about_name' ); ?>"><?php _e( 'Author Name:' ,'bame'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'about_bio' ); ?>"><?php _e( 'Author Bio:' ,'bame'); ?></label>
    ...
    } // Class bame_author_widget ends here


    // Register and load the widget
    function bame_author_load_widget() {
        register_widget( 'bame_author_widget' );
    }
    add_action( 'widgets_init', 'bame_author_load_widget' );