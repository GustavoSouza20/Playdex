"use strict";(globalThis.webpackChunkwp_event_solution=globalThis.webpackChunkwp_event_solution||[]).push([[256],{3175:(e,t,n)=>{n.d(t,{A:()=>_});var a=n(51609),r=n(27723),o=n(500),l=n(6836),i=n(69815),c=n(40372),d=n(47152),s=n(56765),p=n(78821),m=n(67300),u=n(6993),g=n(61282),f=n(46160);const x=i.default.div`
	padding: 10px 20px;
	background-color: #fff;
`,{useBreakpoint:h}=c.Ay;function _(e){const{modalOpen:t,setModalOpen:n,data:i}=e||{},c=Number(i?.tax_total)||0,_=Number(i?.discount_total)||0,v=Number(i?.total_price)||0,y="excl"===i?.tax_display_mode?Number(i?.tax_total):0,E=Math.max(0,v+y-_),b=_>0,w=!h()?.md,A=window?.localized_data_obj||{},k=(0,l.wooOrderLink)(i?.wc_order_id);return(0,a.createElement)(o.A,{centered:!0,title:(0,r.__)("Booking ID","eventin")+" - "+i?.id,open:t,okText:(0,r.__)("Close","eventin"),onOk:()=>n(!1),onCancel:()=>n(!1),width:w?400:700,footer:null,styles:{body:{height:"500px",overflowY:"auto"}},style:{marginTop:"20px"}},(0,a.createElement)(x,null,(0,a.createElement)(p.A,{status:i?.status,discountedPrice:E,currencySettings:A,isTaxIncluded:"incl"===i?.tax_display_mode,taxTotal:c}),(0,a.createElement)(d.A,{align:"middle",style:{margin:"10px 0"}},(0,a.createElement)(m.A,{data:i,wooCommerceOrderLink:k}),(0,a.createElement)(g.A,{isDiscounted:b,data:i,discountedPrice:E,currencySettings:A})),(0,a.createElement)(u.A,{extraFields:i?.extra_fields}),i?.attendees?.length>0?(0,a.createElement)(s.V,{attendees:i?.attendees,onTicketDownload:e=>{let t=`${localized_data_obj.site_url}/etn-attendee?etn_action=download_ticket&attendee_id=${e?.id}&etn_info_edit_token=${e?.etn_info_edit_token}`;window.open(t,"_blank")}}):i?.ticket_items?.length>0&&(0,a.createElement)(f.A,{ticketItems:i?.ticket_items})))}(0,r.__)("Completed","eventin"),(0,r.__)("Failed","eventin")},6292:(e,t,n)=>{n.d(t,{aH:()=>l,yX:()=>i});var a=n(69815),r=n(77278),o=n(47152);a.default.div`
