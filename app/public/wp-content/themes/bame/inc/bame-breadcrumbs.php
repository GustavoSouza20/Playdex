...
if ( ! function_exists( 'bame_breadcrumbs' ) ) {
    function bame_breadcrumbs( $args = array() ) {
        if ( is_front_page() ) {
            return;
        }
        ...
        $defaults  = array(
            ...
            'home_title'          => esc_html__( 'Home', 'bame' )
        );
        $args    = apply_filters( 'bame_breadcrumbs_args', wp_parse_args( $args, $defaults ) );
        ...
        */
        ...
        if ( is_singular( 'post' ) ) {
            ...
            $html .= '<li class="active bread-search">'.esc_html__('Search results for: ','bame') . get_search_query() . '</li>';
        } elseif ( is_404() ) {
            $html .= '<li>' . esc_html__( 'Error Page', 'bame' ) . '</li>';
        } elseif ( is_home() ) {
        ...
        if( class_exists('woocommerce') ) {
            ...
            echo apply_filters( 'bame_breadcrumbs_filter', $html );
        }
