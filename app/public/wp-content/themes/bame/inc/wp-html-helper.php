...
// image default alt
if( !function_exists( 'bame_img_default_alt' ) ){
	function bame_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'bame_img_tag' ) ){
	function bame_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'bame_anchor_tag' ) ){
	function bame_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'bame_heading_tag' ) ){
	function bame_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'bame_paragraph_tag' ) ){
	function bame_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'bame_span_tag' ) ){
	function bame_span_tag( array $args ){
